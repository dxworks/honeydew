...
namespace HoneydewCoreTest.Extractors.Metrics.SemanticMetrics
{
    public class ParameterDependencyMetricTests
    {
        ...
        public void GetRelations_Extract_ShouldHaveRelations_WhenThereAreNonPrimitiveDependencies()
        {
            ...
            Assert.Equal(typeof(ParameterDependencyMetric).FullName, fileRelation1.RelationType);
            ...
            Assert.Equal(typeof(ParameterDependencyMetric).FullName, fileRelation2.RelationType);
