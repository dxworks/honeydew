...
{{
    ...
    public {classType} Class1 {{ }}
        ...
        Assert.Equal("class", classTypes[0].Attributes[0].TargetType);
    ...
    [Theory]
    [FileData(
        "TestData/CSharp/Metrics/Extraction/ClassLevel/Attributes/ClassWithOneAttributeWithOneParam.txt")]
        ...
        string fileContent)
    {
        ...
        {
            Assert.Equal("class", attribute.TargetType);
        }
