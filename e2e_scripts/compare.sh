...
java -jar ./filecomparer.jar csv "$1/honeydew_file_relations.csv" "$2/honeydew_file_relations.csv"
java -jar ./filecomparer.jar csv "$1/honeydew_file_relations_intermediate.csv" "$2/honeydew_file_relations_intermediate.csv"
java -jar ./filecomparer.jar csv "$1/honeydew_file_relations_all.csv" "$2/honeydew_file_all_relations.csv"
java -jar ./filecomparer.jar csv "$1/honeydew_file_relations_all_intermediate.csv" "$2/honeydew_file_relations_all_intermediate.csv"
