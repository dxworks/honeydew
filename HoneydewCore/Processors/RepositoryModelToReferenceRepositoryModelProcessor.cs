                ...
                foreach (var classType in compilationUnitType.ClassTypes)
                {
                    ...
                    switch (classType)
                    {
                        ...
                        case HoneydewModels.CSharp.ClassModel classModel:
                        {
                            ...
                            {
                                switch (existingReferenceEntity)
                                {
                                    case PartialClassModel partialClassModel:
                                    {
                                        model.PartialClass = partialClassModel;
                                        partialClassModel.Classes.Add(model);
                                    }
                                        break;

                                    case ClassModel existingClassModel:
                                    {
                                        var partialClass = new PartialClassModel
                                        {
                                            ClassType = existingClassModel.ClassType,
                                        ...
                                        model.PartialClass = partialClass;

                                        _classModels[(referenceProjectModel, classModel.Name)] = partialClass;
                                    }
                                        break;
                                }
                            }
