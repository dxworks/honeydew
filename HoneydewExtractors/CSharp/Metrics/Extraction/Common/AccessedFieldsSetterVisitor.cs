    ...
    ICSharpDestructorVisitor
{
        ...
        foreach (var memberAccessExpressionSyntax in possibleMemberAccessExpressions)
        {
            ...
            foreach (var visitor in GetContainedVisitors())
            {
                try
                {
                    ...
                    {
                        accessedField =
                            extractionVisitor.Visit(memberAccessExpressionSyntax, semanticModel, accessedField);
    ...
    private void SetAccessedFields(SyntaxNode syntaxNode, SemanticModel semanticModel,
