...
{
    public class LocalVariablesRelationMetric : RelationMetricVisitor
    {
        public LocalVariablesRelationMetric(IRelationMetricHolder metricHolder) : base(metricHolder)
        {
        }
