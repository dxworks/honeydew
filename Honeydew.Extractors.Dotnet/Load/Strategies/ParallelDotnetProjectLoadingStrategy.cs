...
public class ParallelDotnetProjectLoadingStrategy : IDotnetProjectLoadingStrategy
{
    private readonly ILogger _logger;
    private readonly ActualFilePathProvider _actualFilePathProvider;

    public ParallelDotnetProjectLoadingStrategy(ILogger logger, ActualFilePathProvider actualFilePathProvider)
    {
        _logger = logger;
