...
def main():
    ...
    versions.append({
        ...
        "sourceCode": "https://github.com/dxworks/honeydew/tree/v" + version + "/DxWorks.ScriptBee.Plugins.Honeydew",
        "manifest": "https://raw.githubusercontent.com/dxworks/honeydew/v" + version + "/manifest.yaml",
