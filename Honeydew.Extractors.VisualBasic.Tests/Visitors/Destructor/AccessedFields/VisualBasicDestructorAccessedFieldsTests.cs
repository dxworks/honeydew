...
namespace Honeydew.Extractors.VisualBasic.Tests.Visitors.Destructor.AccessedFields;

public class VisualBasicDestructorAccessedFieldsTests
{
    private readonly VisualBasicFactExtractor _factExtractor;
    private readonly Mock<ILogger> _loggerMock = new();

    public VisualBasicDestructorAccessedFieldsTests()
    {
    ...
    [Theory]
    [FilePath("TestData/DestructorWithAccessedFields.txt")]
