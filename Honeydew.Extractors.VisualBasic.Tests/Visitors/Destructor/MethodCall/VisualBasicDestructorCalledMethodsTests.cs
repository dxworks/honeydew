...
namespace Honeydew.Extractors.VisualBasic.Tests.Visitors.Destructor.MethodCall;

public class VisualBasicDestructorCalledMethodsTests
{
    private readonly VisualBasicFactExtractor _factExtractor;
    private readonly Mock<ILogger> _loggerMock = new();

    public VisualBasicDestructorCalledMethodsTests()
    {
    ...
    [Theory]
    [FilePath("TestData/DestructorWithCalledMethods.txt")]
    public async Task Extract_ShouldHaveCalledMethods_WhenGivenDestructor(string filePath)
    {
        ...
        var calledMethod2 = classType.Destructor.CalledMethods[1];
