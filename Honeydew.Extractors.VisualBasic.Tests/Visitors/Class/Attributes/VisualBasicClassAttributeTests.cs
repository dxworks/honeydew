...
namespace Honeydew.Extractors.VisualBasic.Tests.Visitors.Class.Attributes;

public class VisualBasicClassAttributeTests
{
    private readonly VisualBasicFactExtractor _factExtractor;
    private readonly Mock<ILogger> _loggerMock = new();

    public VisualBasicClassAttributeTests()
    {
        var visualBasicAttributeSetterVisitor = new VisualBasicAttributeSetterVisitor(_loggerMock.Object,
    ...
    [Theory]
    [FilePath("TestData/ClassWithOneAttributeWithNoParams.txt")]
    ...
    [Theory]
    [FilePath("TestData/ClassWithOneAttributeWithOneParam.txt")]
    ...
    [Theory]
    [FilePath("TestData/ClassWithMultipleAttributesWithMultipleParams.txt")]
    [FilePath("TestData/ClassWithMultipleAttributesWithMultipleParamsInDifferentSections.txt")]
    ...
    [Theory]
    [FilePath("TestData/ClassWithCustomAttribute.txt")]
    ...
    [Theory]
    [FilePath("TestData/ClassWithExternAttribute.txt")]
