...
namespace Honeydew.Extractors.VisualBasic.Tests.Visitors.Class.Imports;

public class VisualBasicClassImportsTests
{
      private readonly VisualBasicFactExtractor _factExtractor;
    private readonly Mock<ILogger> _loggerMock = new();

    public VisualBasicClassImportsTests()
    {
    ...
    [Theory]
    [FilePath("TestData/ClassWithImports.txt")]
    [FilePath("TestData/InterfaceWithImports.txt")]
    [FilePath("TestData/StructureWithImports.txt")]
    ...
    [Theory]
    [FilePath("TestData/ClassWithImportsWithAlias.txt")]
    [FilePath("TestData/InterfaceWithImportsWithAlias.txt")]
    [FilePath("TestData/StructureWithImportsWithAlias.txt")]
