...
//     {
//         private readonly JsonModelImporter<SolutionModel> _sut;
//
//         public JsonSolutionModelImporterTests()
//         {
//             _sut = new JsonModelImporter<SolutionModel>(new ConverterList());
//         }
//
//         [Fact]
...
//                 @"{""Projects"":[{""Name"":""ProjectName"",""Namespaces"":[{""Name"":""SomeNamespace"",""ClassModels"":[{""FilePath"":""SomePath"",""Name"":""SomeNamespace.FirstClass"",""BaseTypes"":[{""Type"":{""Name"":""object""}, ""Kind"":""class""}],""Fields"":[],""Metrics"":[{""ExtractorName"":""Honeydew.Extractors.Metrics.Extraction.ClassLevel.CSharp.CSharpBaseClassMetric"",""ValueType"":""Honeydew.Extractors.Metrics.Extraction.ClassLevel.CSharp.CSharpInheritanceMetric"",""Value"":{""Interfaces"":[""Interface1""],""BaseClassName"":""SomeParent""}}]}]}]}]}";
//
//             var loadModelFromFile = _sut.Import(fileContent);
//
...
//             Assert.Equal("Honeydew.Extractors.Metrics.Extraction.ClassLevel.CSharp.CSharpInheritanceMetric",
